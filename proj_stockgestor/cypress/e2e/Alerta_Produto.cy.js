// describe('Alerta de produto', () => {

//   it('Como usuário, eu gostaria de ser informado quando um produto esta em baixo estoque', () => {
...
//      cy.wait(3000);
//      cy.get('.table-danger > :nth-child(3)').should('contain', '1');
